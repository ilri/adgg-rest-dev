...
class AnimalMovementCommand extends command
{
    private const PAGE_SIZE = 100;
    private const OUTPUT_DIR = '/output/animal_movement/';
    private const OUTPUT_FILE = 'animal_movement_log_%s.csv';

    /**
     * @var string
     */
    protected static $defaultName = 'adgg:animal-movement';

    /**
     * @var string
     */
    protected static $defaultDescription = 'Finds and move animals exited to there new farms.';

    /**
     * @var string
     */
    protected static $defaultHelp = 'Creates a CSV file showing the movement of animal from one farm to the next, which have been located using farm_id.';
