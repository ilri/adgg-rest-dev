...
class HerdRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(Herd $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Herd $entity, bool $flush = true): void
    {
    ...
    // /**
    //  * @return Coreanimalherd[] Returns an array of Coreanimalherd objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?Coreanimalherd
    {
        return $this->createQueryBuilder('c')
            ->andWhere('c.exampleField = :val')
            ->setParameter('val', $value)
