...
class MobAdditionalAttributesNormalizer implements NormalizerInterface, DenormalizerInterface, CacheableSupportsMethodInterface
{
    private const TRAIT = 'App\Entity\Traits\MobAdditionalAttributesTrait';
    ...
    /**
     * MobAdditionalAttributesNormalizer constructor.
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        //Checks whether object contains mobile additional attributes
        $mobAdditionalAttributes = $data['mobAdditionalAttributes'] ?? null;

        //Updates the mobile additional attributes array
        if ($mobAdditionalAttributes) {
            $modifiedAttributes = $this->updateMobAdditionalAttributes($mobAdditionalAttributes, 'normalize');
    ...
    public function denormalize($data, string $type, string $format = null, array $context = [])
    {
        ...
        if ($mobAdditionalAttributes){
            $modifiedAttributes = $this->updateMobAdditionalAttributes($mobAdditionalAttributes, 'denormalize');
            $data['MobAdditionalAttributes'] = $modifiedAttributes;
        }
...
//        return 'object' === gettype($data) && in_array(self::TRAIT, class_uses($data));
     ...
     * @return array
     */
    private function updateMobAdditionalAttributes(array $mobAdditionalAttributes, string $serializationType): array
    {
        //Initialized to replace original additional attribute array
        $modifiedAdditionalAttributes = [];

        foreach ($mobAdditionalAttributes as $key => $value) {
